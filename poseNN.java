...
class Pose{
	...
	static int n1=960,n2=550,n3=4;
	static double alpha = 0.004, momentum = 0.002;
	...
	public static double[] create_labels(String s, int n3){
		...
		String t = attributes[1];
		if(t.equals("left")) id = 0;
		else if(t.equals("right")) id = 1;
		else if(t.equals("straight")) id = 2;
		else if(t.equals("up")) id = 3;
	...
	String trainFile="pose_train.list";
	FileInputStream fin;
...
///////////////////////////////////////////////////////////////////////
	...
	*/
	...
	while(dobaar>0){
		dobaar--;
		if(dobaar==1)trainFile="pose_test1.list";
		else if(dobaar==0)trainFile="pose_test2.list";
