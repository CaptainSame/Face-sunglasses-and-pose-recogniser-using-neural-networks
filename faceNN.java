...
class Face{
	...
	static int n1=960,n2=500,n3=20;
	static double alpha = 0.008, momentum = 0.004;
	...
	public static double[] create_labels(String s, int n3){
		...
		String t = attributes[0];
		if(t.equals("an2i")) id = 0;
		else if(t.equals("at33")) id = 1;
		else if(t.equals("boland")) id = 2;
		else if(t.equals("bpm")) id = 3;
		else if(t.equals("ch4f")) id = 4;
		else if(t.equals("cheyer")) id = 5;
		else if(t.equals("choon")) id = 6;
		else if(t.equals("danieln")) id = 7;
		else if(t.equals("glickman")) id = 8;
		else if(t.equals("karyadi")) id = 9;
		else if(t.equals("kawamura")) id = 10;
		else if(t.equals("kk49")) id = 11;
		else if(t.equals("megak")) id = 12;
		else if(t.equals("mitchell")) id = 13;
		else if(t.equals("night")) id = 14;
		else if(t.equals("phoebe")) id = 15;
		else if(t.equals("saavik")) id = 16;
		else if(t.equals("steffi")) id = 17;
		else if(t.equals("sz24")) id = 18;
		else if(t.equals("tammo")) id = 19;
	...
	String trainFile="face_train.list";
	FileInputStream fin;
...
///////////////////////////////////////////////////////////////////////
	...
	*/
	...
	while(dobaar>0){
		dobaar--;
		if(dobaar==1)trainFile="face_test1.list";
		else if(dobaar==0)trainFile="face_test2.list";
